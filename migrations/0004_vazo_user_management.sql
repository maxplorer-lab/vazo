-- Vazo user management, one-time invite PINs, and on-demand media enrichment.
-- The separate Vazo D1 database must be selected before applying this migration.
...
CREATE INDEX IF NOT EXISTS idx_media_enrichment_source
  ON media_enrichment_cache(source, fetched_at);
